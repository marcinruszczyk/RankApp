...
const RankItemsContainer = ({dataType, imgArr }) => {
    ...
    const [albumItems, setAlbumItems] = useState(JSON.parse(localStorage.getItem("albums")));
    const [movieItems, setMovieItems] = useState(JSON.parse(localStorage.getItem("movies")));
